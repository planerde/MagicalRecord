...
{
    static NSMutableDictionary* dictFormatterForFormat = nil;
    
    if (!dictFormatterForFormat) {
        dictFormatterForFormat = [[NSMutableDictionary alloc] init];
    }
    
    NSDateFormatter* formatter = [dictFormatterForFormat objectForKey:format];
